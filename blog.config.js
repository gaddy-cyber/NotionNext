...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Rayya', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '故事的本质，就是我们看透了错误。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://learnt.site/', // 网站地址
